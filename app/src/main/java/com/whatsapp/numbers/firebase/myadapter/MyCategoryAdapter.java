...
import com.whatsapp.numbers.firebase.SubCategoryActivity;
...
public class MyCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MyCategoryAdapter(Context context, List<Object> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder.getItemViewType() == ITEM_DATA_TYPE){
           ...
           MyCategory myCategory = (MyCategory) list.get(position);
    ...
    public int getItemViewType(int position) {
        return list.get(position) instanceof MyCategory ? ITEM_DATA_TYPE : ITEM_AD_TYPE;
    }
    @Override
    ...
    class MyCategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void bindName(String name){
            ...
            mName.setText(name);
            mSubTitle.setText("Hi, I am from " + name + ".");
        }
        ...
        public void onClick(View v) {
            MyCategory myCategory = (MyCategory) list.get(getAdapterPosition());
            Intent intent = new Intent(context , SubCategoryActivity.class);
            intent.putExtra(MyConstant.CATEGORY_NAME , myCategory.getName());
    ...
    public class AdViewHolder extends RecyclerView.ViewHolder {
        ...
        void loadFbNativeAd(final NativeAd nativeAd) {
            try {
